...
func cloneStep(in Inputs) hades.Step {
	...
	return hades.Step{
		ID:              1,
		Name:            "Clone",
		Image:           orDefault(in.Policy.Clone.Image, "ghcr.io/ls1intum/momos-clone:latest"),
...
func reviewStep(in Inputs) hades.Step {
	...
	return hades.Step{
		ID:              2,
		Name:            "AI Review",
		Image:           orDefault(r.Image, "ghcr.io/ls1intum/momos-reviewer:latest"),
		Script:          "/app/reviewer",
...
func publishStep(in Inputs) hades.Step {
	...
	return hades.Step{
		ID:          3,
		Name:        "Publish",
		Image:       orDefault(p.Image, "ghcr.io/ls1intum/momos-publisher:latest"),
